...
Stable, integrated SkillBridge code.
...
Could this cause duplicates, broken references, or data loss?
...
Does the PR contain unrelated changes?
...
P0
Critical blocker/security issue
...
API changes must be communicated and the API specification must be updated.
...
and environment-specific secret management.
...
Spring Boot + PostgreSQL interaction.
...
How badly does the bug affect the system?
...
Resume button has a 2-pixel alignment issue.

Low severity, low priority.

Another student can see someone else's private resume.

Extremely high severity and priority.
